...
class Gutenberg_Blocks_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $gutenberg_blocks       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->gutenberg_blocks, plugin_dir_url( __FILE__ ) . 'css/gutenberg-blocks-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->gutenberg_blocks, plugin_dir_url( __FILE__ ) . 'js/gutenberg-blocks-public.js', array( 'jquery' ), $this->version, false );
